...
----
	@Service
	public class com.ambity.MyService {

		public com.ambity.MyService(ConversionService conversionService) {
...
----
	@Service
	class com.ambity.MyService(private val conversionService: ConversionService) {
...
----
	...
	@Service
	class com.ambity.MyService(@Autowired private val validator: Validator)
----
