...
----
	beans {
		...
		myService(com.ambity.MyService) {
...
----
	...
	public class AppConfig {
		...
		@Bean
		public com.ambity.MyService myService() {
...
----
	...
	class AppConfig {
		...
		@Bean
		fun myService(): com.ambity.MyService {
...
----
	public static void main(String[] args) {
		...
		com.ambity.MyService myService = ctx.getBean(com.ambity.MyService.class);
		myService.doStuff();
	}
----
[source,kotlin,indent=0,subs="verbatim,quotes",role="secondary"]
...
----
	...
	fun main() {
		...
		val myService = ctx.getBean<com.ambity.MyService>()
		myService.doStuff()
	}
----
